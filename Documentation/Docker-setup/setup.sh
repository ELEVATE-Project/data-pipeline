...
curl -OJL https://github.com/prashanthShiksha/data-pipeline/blob/dev-deploy/Documentation/Docker-setup/docker-compose.yml
log "Docker Compose file downloaded."

# Step 2: Download environment files
log "Downloading required files..."
curl -L \
    -O https://github.com/prashanthShiksha/data-pipeline/blob/dev-deploy/Documentation/Docker-setup/config.env \
    -O https://github.com/prashanthShiksha/data-pipeline/blob/dev-deploy/Documentation/Docker-setup/config_files/base-config.conf \
    -O https://github.com/prashanthShiksha/data-pipeline/blob/dev-deploy/Documentation/Docker-setup/config_files/metabase-dashboard.conf \
    -O https://github.com/prashanthShiksha/data-pipeline/blob/dev-deploy/Documentation/Docker-setup/config_files/project-stream.conf \
    -O https://github.com/prashanthShiksha/data-pipeline/blob/dev-deploy/Documentation/Docker-setup/create_table.sh \
    -O https://github.com/prashanthShiksha/data-pipeline/blob/dev-deploy/Documentation/Docker-setup/data-loader.sh \
    -O https://github.com/prashanthShiksha/data-pipeline/blob/dev-deploy/Documentation/Docker-setup/deploy_flink_job.sh \
    -O https://github.com/prashanthShiksha/data-pipeline/blob/dev-deploy/Documentation/Docker-setup/dummy-data.json \
    -o https://github.com/prashanthShiksha/data-pipeline/blob/dev-deploy/Documentation/Docker-setup/submit-jobs.sh
