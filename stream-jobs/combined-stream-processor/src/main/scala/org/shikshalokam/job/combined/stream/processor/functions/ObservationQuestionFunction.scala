...
case class QuestionParams(
                           ...
                           userOneProfileName: String, userOneProfileId: String, userTwoProfileName: String, userTwoProfileId: String, userThreeProfileName: String, userThreeProfileId: String, userFourProfileName: String, userFourProfileId: String, userFiveProfileName: String, userFiveProfileId: String,
                           tenantId: String, orgId: String, orgCode: String, orgName: String, statusOfSubmission: String, submittedAt: String, entityType: String, entityId: String, entityName: String, entityExternalId: String,
                           ...
                           domainName: String, criteriaName: String, score: Integer, hasParentQuestion: Boolean, parentQuestionText: String, evidences: String, remarks: String, reportType: String
                         )

class ObservationQuestionFunction(postgresUtil: PostgresUtil, questionTable: String) {
  ...
  def processQuestionType(params: QuestionParams, questionType: String): Unit = {
    ...
    val questionParam = Seq(
      ...
      params.userOneProfileName, params.userOneProfileId, params.userTwoProfileName, params.userTwoProfileId,
      params.userThreeProfileName, params.userThreeProfileId, params.userFourProfileName, params.userFourProfileId,
      params.userFiveProfileName, params.userFiveProfileId, params.tenantId, params.orgId, params.orgCode,
      params.orgName, params.statusOfSubmission, params.submittedAt, params.entityType, params.entityId, params.entityName, params.entityExternalId,
      ...
      params.parentQuestionText, params.evidences, params.remarks, questionType, labels, params.reportType
    )
  ...
  private val insertQuestionQuery =
    s"""INSERT INTO $questionTable (
       ...
       |    observation_name, observation_id, user_one_profile_name, user_one_profile_id, user_two_profile_name, user_two_profile_id,
       |    user_three_profile_name, user_three_profile_id, user_four_profile_name, user_four_profile_id, user_five_profile_name, user_five_profile_id,
       |    tenant_id, org_id, org_code, org_name, status_of_submission, submitted_at, entity_type, entity_id, entity_name, entity_external_id, parent_one_name,
       ...
       |    value, score, has_parent_question, parent_question_text, evidence, remarks, question_type, labels, report_type
       |) VALUES (
       |    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?
       |)""".stripMargin
