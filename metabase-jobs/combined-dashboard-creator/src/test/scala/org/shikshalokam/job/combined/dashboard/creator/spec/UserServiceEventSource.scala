...
class UserServiceEventSource extends SourceFunction[UserMappingEvent] {
...
//        ctx.collect(new Event(JSONUtil.deserialize[java.util.Map[String, Any]](UserEventsMock.DELETE_USER_WITH_EMAIL_TENANT_ADMIN), 0, 0))
    ctx.collect(new UserMappingEvent(JSONUtil.deserialize[java.util.Map[String, Any]](UserEventsMock.CREATE_EVENT_WITH_EMAIL_AND_PHONE_ORG_ADMIN), 0, 0))
